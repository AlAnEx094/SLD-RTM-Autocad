-- 0001_init.sql
-- MVP-0.1: SQLite схема + минимальные сущности для CalcCore:
-- - расчёт РТМ
-- - фазировка (phase balance)
--
-- Важно: внешние ключи включаются на уровне соединения (tools),
-- но в схеме FK обязаны быть прописаны.
